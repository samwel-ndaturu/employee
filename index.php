...
<html lang="en">
    ...
    <body>
        ...
        <div class="mn-content fixed-sidebar">
          ...
          <div class="footer">
                    <p class="copyright"><a href="">samwel ndaturu </a>©</p>
                ...
                <div class="row">
                    <div class="col s10">
                        <div class="page-title"><h4>Welcome to Employee Leave Management System</h4></div>
                          ...
                          <div class="col s10 m6 l0 offset-10 offset-m3">
                              <div class="card white darken-1">

                                  <div class="card-content ">
                                      <span class="card-title" style="font-size:10px;">Employee Login</span>
                                         <?php if($msg){?><div class="errorWrap"><strong>Error</strong> : <?php echo htmlentities($msg); ?> </div><?php }?>
                                       <div class="row">
                                           <form class="col s10" name="signin" method="post">
                                               ...
                                               <div class="col s10 right-align m-t-sm">
