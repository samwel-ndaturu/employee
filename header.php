...
<ul class="nav-tabs">
                                <li class="nav-item">
                                    <a class="nav-link active" arial-current="page" href="leaves.php">All Leaves </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active" arial-current="page" href="pending-leavehistory.php">Pending Leaves </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active" arial-current="page" href="approvedleave-history.php">Approved Leaves</a>
                                </li>
                                  <li class="nav-item">
                                    <a class="nav-link active" arial-current="page" href="notapproved-leaves.php">Not Approved Leaves</a>
                                </li>
...
{               ?>  
                                    ...
                                    <li>
                                        ...
                                        <div class="notification">
                                            ...
                                            <div class="notification-text"><p><b><?php echo htmlentities($result->FirstName." ".$result->LastName);?><br />(<?php echo htmlentities($result->EmpId);?>)</b> applied for leave</p><span>at <?php echo htmlentities($result->PostingDate);?></br></span></div>
                                        </div>
                                        </a>
                                    </li>
                                   <?php }} ?>
